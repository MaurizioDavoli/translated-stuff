...
class FrontApiUtility:
    ...
    @staticmethod
    def create_url(start, end, tag, inbox):
    ...
    def get_one_day_conversations(self, start_date, day_range=1, tag=None, inbox=None):
        ...
        dates = self.get_date_range(start_date, day_range)
        query_url = self.create_url(dates[0], dates[1], tag, inbox)
        searched_data = {}
        first_page = True
    ...
    def get_last_week_conversations(self, start_date, tag=None, inbox=None):
